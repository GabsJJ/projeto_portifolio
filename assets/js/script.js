...
async function getApiGitHub() {
    try{
        //Envia uma requisição à API do GitHub
        const dadosPerfil = await fetch(`https://api.github.com/users/GabsJJ`)

        //converte a resposta HTML para JSON
        ...
        <article id="about_texto">
            <h1>Sobre mim</h1>
            <p>
                Mussum Ipsum, cacilds vidis litro abertis. Interagi no mé, cursus quis, vehicula ac nisi. Quem manda
        ...
        `
        //adicionar conteudo na index.html
